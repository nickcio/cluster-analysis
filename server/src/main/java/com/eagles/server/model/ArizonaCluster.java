...
@Document(collection = "ArizonaCluster")
public class ArizonaCluster {
    @Id
    private String _id;
    ...
    public ArizonaCluster(String _id, int num_district_plans, List<String> district_plans, List<Double> centroid,
