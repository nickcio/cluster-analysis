...
@Getter
@Setter
@Document(collection = "ArizonaDistrictPlans")
public class ArizonaDistrictPlans {
    @Id
    private String _id;
    @Field("geojson_id")
    ...
    public ArizonaDistrictPlans(String _id, String geojson_id,List<Double> mds_centroid, Map<String, Double>dem_percentages,
