...
@Getter
@Setter
@Document(collection = "SCDistrictPlans")
public class SCDistrictPlans {
    @Id
    private String _id;
    @Field("geojson_id")
    ...
    public SCDistrictPlans(String _id, String geojson_id,List<Double> mds_centroid, Map<String, Double>dem_percentages,
